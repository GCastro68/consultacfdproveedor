...
var anioini=mifecha.getFullYear()-2;
var aniofin=mifecha.getFullYear();


var gBegin=[anioini,mes,dia];	// calendar date range begin from [Year,Month,Date]. Using gToday here will make it start from today.
var gEnd=[aniofin,mes,dia];	// calendar date range end at [Year,Month,Date]
